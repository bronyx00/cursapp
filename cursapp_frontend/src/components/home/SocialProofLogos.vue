<template>
  <div class="py-16 bg-background sm:py-24">
    <div class="container mx-auto px-4">
      <h2 class="text-center text-lg font-semibold leading-8 text-muted-foreground">
        Usado por los equipos más innovadores del mundo
      </h2>
